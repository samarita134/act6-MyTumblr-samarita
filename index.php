...
$acc_usernmae = "KarenJoy";
$acc_password = "karen121";
$acc_fullname = "Karen Joy Samarita";
$acc_address = "Polo Sta. Cruz Marinduque PH";
...
if(isset($_REQUEST['login_button']) === true){
  //get the username aand password from the form and compare to the predefined username and password
	//kapag mali agad yung username
	if($_REQUEST['form_username'] != $acc_usernmae){
		header("Location: ".$url_add."?notexist");
	}
	//tama ang username pro mali ang password
	else if ($_REQUEST['form_username'] == $acc_usernmae && $_REQUEST['form_password'] != $acc_password ){
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      				...
		      				echo "<div class='aalert alert-success' role='alert'> Redirecting... </div>";
