        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="file:///C:/Users/Rio%20Marinella/Pictures/Image/pic1.jpg.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
                    ...
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0">Karen Joy B. Samarita</h4>
                        <p class="small mb-4"> <i class="fas fa-map-marker-alt mr-2"></i>Polo Sta. Cruz Marinduque PH
                         </p>
                    </div>
                </div>
            </div>
